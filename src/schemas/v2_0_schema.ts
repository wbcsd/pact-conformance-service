/**
 * V2.0 Schema Definitions
 * 
 * This file extracts and converts OpenAPI v2.0 schemas to AJV-compatible JSON schemas.
 * The schemas are sourced from the authoritative OpenAPI specification file.
 * 
 * Source: /src/schemas/openapi_v2_0.yaml
 */

import path from 'path';
import { OpenApiSchemaExtractor } from '../utils/openApiSchemaExtractor';

// Create extractor instance for v2.1 OpenAPI specification
const openApiExtractor = new OpenApiSchemaExtractor(
  path.join(__dirname, '../schemas/openapi_v2_0.yaml')
);
