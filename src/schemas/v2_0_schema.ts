// Product Footprint and Response Schema for v2.0
export const v2_0_productFootprintSchema = {
  type: "object",
  ...
  CarbonFootprint: {
    ...
    properties: {
      ...
      pCfIncludingBiogenic: {
        type: "string",
        pattern: "^[+-]?\\d+(\\.\\d+)?$",
        description: "The PCF of the product including all biogenic emissions.",
      },
      fossilGhgEmissions: {
        type: "string",
        pattern: "^[+]?\\d+(\\.\\d+)?$",
...
export const v2_0_ResponseSchema = {
...
export const v2_0_SingleFootprintResponseSchema = {
  type: "object",
  properties: {
    data: {
      $ref: "#/definitions/ProductFootprint",
